...
public final class GetRepositoriesQuery: GraphQLQuery {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static var selections: [GraphQLSelection] {
      return [
        GraphQLField("search", arguments: ["query": "GraphQL", "after": GraphQLVariable("page"), "type": "REPOSITORY", "first": 10], type: .nonNull(.object(Search.selections))),
      ]
    }
    ...
    public struct Search: GraphQLSelectionSet {
      ...
      public struct Edge: GraphQLSelectionSet {
        ...
        public struct Node: GraphQLSelectionSet {
          ...
          public static func makeRepository(name: String, owner: AsRepository.Owner, stargazers: AsRepository.Stargazer) -> Node {
            return Node(unsafeResultMap: ["__typename": "Repository", "name": name, "owner": owner.resultMap, "stargazers": stargazers.resultMap])
          }
